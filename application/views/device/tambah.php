                ...
                ?>                   
                    <div class="box-body"> 
                        <div class="form-group">
                            ...
                            <input name="kode" class="form-control" rows="3" required oninvalid="setCustomValidity('Input No. Inventory Sesui Device Type ')"
                                   oninput="setCustomValidity('')" placeholder="NET-PMT-001, CCT-PMT-001">
                            <?php echo form_error('kode', '<div class="text-red">', '</div>'); ?>                            
                        </div>
                        <div class="form-group">
                            <label>Device Type</label>
                            <input name="jenis" class="form-control" rows="3" required oninvalid="setCustomValidity('Network Device Harus di Isi !')"
                                   oninput="setCustomValidity('')" placeholder="Switch, HUB, Router, CCTV, Dll">
                            <?php echo form_error('jenis', '<div class="text-red">', '</div>'); ?>                            
                        </div>                             
                        <div class="form-group">
                            <label for="">Spesifikasi</label>
                            <textarea name="spek" class="form-control" rows="3" required oninvalid="setCustomValidity('Spesifikasi Device Harus di Isi !')"
                        ...
                        <div class="form-group">
                            ...
                            <input name="lokasi" class="form-control" rows="3" required oninvalid="setCustomValidity('Lokasi Device Harus di Isi !')"

        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class='box-header with-border'>
                    <h3 class='box-title'>
                        <a href="<?php echo base_url('device/add'); ?>" class="btn btn-primary btn-small"><i class="glyphicon glyphicon-plus"></i> Tambah Data</a>
                        <a href="<?php echo base_url('device/barcode'); ?>" class="btn btn-primary btn-small"><i class="glyphicon glyphicon-barcode" > </i> Lihat Barcode</a>
                    </h3>

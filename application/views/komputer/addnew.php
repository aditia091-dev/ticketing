...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box-header"> 
            <?php
                echo form_open('komputer/maintadd/'.$record['kode_komputer']);
            ?>            
            <table class="table">               
                <tr>
                    <td><label>No.Inventaris</label></td>
                    <td>
                        <input type="hidden" name="inventaris" value="<?php echo $record['kode_komputer']; ?>">
                        <div class="col-sm-4"><label><?php echo $record['kode_komputer']; ?></label></div>                        
                    </td>
                <tr>
                <tr>
                    <td style="width:15%"><label>Jenis Inventaris</label></td>
                    <td>
                        <div class="col-sm-4"><label>Komputer</label></div>                        
                    </td>
                <tr> 
                <tr>
                    ...
                    <td>
                        <div class=" col-sm-4">
                            <div class=" input-group">
                                ...
                                <input type="datetime" name="tgl_permohonan" class="form-control datepicker" id="datetimepicker" placeholder="yyyy-mm-dd hh:mm" >                            
                            </div>
                        </div>

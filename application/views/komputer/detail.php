                        ...
                        ?>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="remote" class="form-control" rows="2"  required oninvalid="setCustomValidity('Remote Akses Harus di Isi !')"
                                           oninput="setCustomValidity('')" placeholder="Remote Akses"><?php echo $record['remote_akses']; ?></textarea>

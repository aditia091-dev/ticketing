...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box-header"> 
            <?php
                echo form_open('laptop/maintadd/'.$record['kode_laptop']);
            ?>            
            <table class="table">               
                <tr>
                    <td><label>No.Inventaris</label></td>
                    <td>
                        <input type="hidden" name="inventaris" value="<?php echo $record['kode_laptop']; ?>">
                        <div class="col-sm-4"><label><?php echo $record['kode_laptop']; ?></label></div>                        
                    </td>
                <tr>
                <tr>
                    <td style="width:15%"><label>Jenis Inventaris</label></td>
                    <td>
                        <div class="col-sm-4"><label>Laptop</label></div>                        
                    </td>
                <tr> 
                <tr>

    ...
    function tampil_tanggal() {
        ...
        if (tglawal==''){
            ...
            $('#mytable').dataTable({
                ...
                "ajax": {
                    "url": "<?php echo base_url('laptop/view_tanggal'); ?>",
                    "type": "GET",
                    "data": {                   
                        'tglawal': tglawal,
                        'tglakhir': tglakhir,
                ...
                <div class='box-header with-border'>                    
                    <table class="table">
                        <tr>
                            <td colspan="6">
                                <h3 class='box-title'>
                                    <a href="<?php echo base_url('laptop/add'); ?>" class="btn btn-primary btn-small"><i class="glyphicon glyphicon-plus"></i> Tambah Data</a>
                                    <a href="<?php echo base_url('laptop/barcode'); ?>" class="btn btn-primary btn-small"><i class="glyphicon glyphicon-barcode" > </i> Lihat Barcode</a>
                                </h3>

            ...
            <div class="container clearfix">
              <div class="row">
                <div class="col-md-8 col-md-offset-2 col-sm-12">
                  <p class="italic">PT Mazta Farma</p>
                  <h1>SIMITA</h1>
                  <p class="italic">Ticketing Troubleshooting</p>
                ...
                <p class="italic">Berlaku untuk Head Office & Seluruh cabang PT Mazta Farma</p>
              </div>
			  <div class="row">
